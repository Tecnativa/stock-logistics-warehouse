...
stock location per partner.

A putaway strategy can be used to ensure that incoming products will be
stored in the location set on the partner form.
...
partner location in each warehouse it is received.
...
#. For the new putaway strategy, select 'Fixed per partner location'
   as method
...
#. Select the proper stock locations for each partner on the partner form
